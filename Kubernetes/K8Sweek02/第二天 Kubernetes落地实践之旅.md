...
- LivenessProbe探针
  ...
  ![](C:\Users\liyongxin\Desktop\wework\老男孩\训练营\大课\images\livenessprobe.webp)
...
- ReadinessProbe探针
  ...
  ![](C:\Users\liyongxin\Desktop\wework\老男孩\训练营\大课\images\readnessprobe.webp)
...
mysql    1/1     Running   0          52s   192.168.136.11   k8s-slave1
...
$ docker build . -t 192.168.136.10:5000/myblog:v2 -f Dockerfile
$ docker push 192.168.136.10:5000/myblog:v2
...
$ kubectl -n luffy set image deploy myblog myblog=192.168.136.10:5000/myblog:v2 --record=true
...
$ curl 192.168.136.10:30647/blog/index/
我的博客列表
$ curl 192.168.136.11:30647/blog/index/
我的博客列表
## 浏览器访问
...
```json
192.168.136.10 myblog.luffy.com
